...
[![Go Report Card](https://goreportcard.com/badge/github.com/YKG/parser)](https://goreportcard.com/report/github.com/YKG/parser)
[![CircleCI Status](https://circleci.com/gh/pingcap/parser.svg?style=shield)](https://circleci.com/gh/pingcap/parser)
[![GoDoc](https://godoc.org/github.com/YKG/parser?status.svg)](https://godoc.org/github.com/YKG/parser)
...
- Highly compatible with MySQL: it supports almost all features of MySQL. For the complete details, see [parser.y](https://github.com/YKG/parser/blob/master/parser.y) and [hintparser.y](https://github.com/YKG/parser/blob/master/hintparser.y).
- Extensible: adding a new syntax requires only a few lines of Yacc and Golang code changes. As an example, see [PR-680](https://github.com/YKG/parser/pull/680/files).
...
Please read the [quickstart](https://github.com/YKG/parser/blob/master/docs/quickstart.md).
...
- [GitHub Issue](https://github.com/YKG/parser/issues)
...
Here is how to [update parser for TiDB](https://github.com/YKG/parser/blob/master/docs/update-parser-for-tidb.md).
